...
contract ERC20TokenAvalanche is ERC20, Owned {
    ...
    constructor(
        ...
        uni_factory = JoeRouter02(uni_router).factory();
        weth = _weth;
    ...
    function swapTokensForEth(uint amount) private lockTheSwap {
        ...
        try JoeRouter02(uni_router).swapExactTokensForAVAXSupportingFeeOnTransferTokens(
            amount,
            0,
            path,
            tax_receiver,
    ...
    function addLp(uint amount) external payable onlyOwner {
        ...
        JoeRouter02(uni_router).addLiquidityAVAX{value: balance}(
            address(this),
            amount,
            amount,
            balance,
